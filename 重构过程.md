...
### 基于大模型写脚本
    ...
    2.训练脚本写到torchrun_multi_node_multi_gpu.sh
    参考run_dpo.sh,dpo_training.py
        1.基于torchrun实现分布式训练脚本 
        2.训练脚本写到DPO目录中的torchrun_multi_node_multi_gpu.sh中


    参考脚本
    1.基于deepspeed实现分布式训练脚本
    2.训练脚本写到deepspeed_multi_node_multi_gpu.sh
