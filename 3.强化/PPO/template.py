...
class Conversation:
    ...
    def _format_example(
        ...
        Returns:
            List[str]: 格式化后的对话序列，包含问题和答案交替出现的字符串列表
                      长度为 2 * n，其中偶数索引(0,2,4...)是问题，奇数索引(1,3,5...)是答案
        ...
        Example: qwen为例
            ...
            conv = Conversation(
                ...
                messages=[["你好", "你好！很高兴为您服务"], ["今天天气怎么样", "今天天气很好"]],
                roles=("user", "assistant"),
                prompt="<|im_start|>user\n{query}<|im_end|>\n<|im_start|>assistant\n",
                sep="\n"
            )
            
            conv._format_example()
